        ...
        response = await mcp_server.handle_request(
            {
                ...
                "params": {
                    "name": "lobster_sweep",
                    "arguments": {"conversation_id": sample_conversation_id, "days_threshold": 30},
                },
            }
        )
        ...
        response = await mcp_server.handle_request(
            {
                ...
                "params": {
                    "name": "lobster_sweep",
                    "arguments": {"conversation_id": sample_conversation_id, "days_threshold": 60},
                },
            }
        )
...
def test_edge_case_missing_conversation_id(mcp_server):
    ...
    async def run_test():
        ...
        response = await mcp_server.handle_request(
            {
                "method": "tools/call",
                "params": {"name": "lobster_sweep", "arguments": {"days_threshold": 30}},
            }
        )
