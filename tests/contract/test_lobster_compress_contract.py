        ...
        response = await mcp_server.handle_request(
            {
                ...
                "params": {
                    ...
                    "arguments": {"conversation_id": sample_conversation_id, "token_budget": 8000},
                },
            }
        )
...
def test_response_field_types(mcp_server, sample_conversation_id):
    ...
    async def run_test():
        ...
        if "compression_ratio" in result:
            assert isinstance(
                result["compression_ratio"], (int, float)
        ...
        response = await mcp_server.handle_request(
            {
                ...
                "params": {
                    "name": "lobster_compress",
                    "arguments": {"conversation_id": empty_conversation_id, "token_budget": 8000},
                },
            }
        )
