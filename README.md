...
**最新版本**: [v4.0.21](https://github.com/SonicBotMan/lobster-press/releases/tag/v4.0.21) · [更新日志](CHANGELOG.md)
...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v4.0.21** ⭐ | 2026-03-21 | Issue #154 修复（ESM 兼容 + 截断逻辑） |
| **v4.0.21** | 2026-03-21 | Issue #153 修复（per-session 锁 + 版本动态） |
| **v4.0.21** | 2026-03-21 | README 重写 + 学术引用 |
| v4.0.21 | 2026-03-20 | 安全修复（CodeQL） |
| v4.0.21 | 2026-03-19 | 五大模块重构 |
| v4.0.21 | 2026-03-19 | Bug 修复（7 个） |
| v4.0.21 | 2026-03-19 | MemOS 架构 |
| v4.0.21 | 2026-03-19 | ContextEngine 集成 |
| v4.0.21 | 2026-03-17 | LLM 多提供商 |
| v4.0.21 | 2026-03-17 | 认知科学重构 |
| v4.0.21 | 2026-03-13 | 初始发布 |
