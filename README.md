...
**最新版本**: [v4.0.18](https://github.com/SonicBotMan/lobster-press/releases/tag/v4.0.18) · [更新日志](CHANGELOG.md)
...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v4.0.18** ⭐ | 2026-03-21 | Issue #154 修复（ESM 兼容 + 截断逻辑） |
