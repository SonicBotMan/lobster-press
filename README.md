...
**最新版本**: [v4.0.29](https://github.com/SonicBotMan/lobster-press/releases/tag/v4.0.29) · [更新日志](CHANGELOG.md)
...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v4.0.29** ⭐ | 2026-03-22 | Issue #167 审计修复（5 个 Bug） |
